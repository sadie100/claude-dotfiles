...
<!-- harness-sync-fingerprint: ff18619f64b13cd92be1478ec3b24e5fd1a1250e143d6030b73f5780a688ac60 -->
...
| `SessionStart` | `"$DOTCLAUDE_DIR/scripts/local-skills-link/local-skills-link.sh"`                                                      | ❌ (sync) | 세션 시작 시 로컬 스킬 심볼릭 링크 갱신                          |
