...
- Run `node "$DOTCLAUDE_DIR/scripts/harness-sync/harness-sync.mjs"` to refresh HARNESS.md, then `node "$DOTCLAUDE_DIR/scripts/dotfiles-sync/dotfiles-sync.mjs"` to push changes to remote.
